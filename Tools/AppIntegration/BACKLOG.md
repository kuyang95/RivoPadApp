...
- Siri·단축어에 노출되는 다음 9개 App Shortcut과 한국어 문구:
  AI 채팅, 독서, 카메라, 문서 스캔, 돋보기, 실시간 글자 읽기,
...
- 위젯의 `rivopad://open/<기능>` URL과 App Shortcut이 같은 화면
  목적지 모델을 사용
- 9개 바로가기의 App Intents 메타데이터 추출과 화면 envelope
  직렬화·역직렬화 자동 테스트
...
- [ ] Apple Developer 최신 Program License Agreement 동의 뒤 확장 포함
      앱을 M4 iPad에 설치한다.
- [ ] 단축어 앱의 VisionCraft 동작 목록에 9개 바로가기와 기존
